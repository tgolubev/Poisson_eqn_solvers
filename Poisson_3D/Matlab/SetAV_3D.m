...
j = 1;
k = 2;
for index = 1+N*N:N^3  %note: N^3-N^2 elements, but shifted by N^2 b/c of matlab filling convention     %matlab fills from bottom, so this starts at 1+N (since 1st element is in the 2nd subblock of matrix)
